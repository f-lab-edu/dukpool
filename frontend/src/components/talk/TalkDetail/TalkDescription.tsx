...
import { usePostTalkPrefer } from '@hooks/usePostMutations';
import { useDeleteTalkPrefer, useDeleteTalk } from '@hooks/useDeleteMutations';
        ...
        <StyledInfoContainer>
          <StyledUserProfileContainer>
            ...
            {userUniqId === writer.id && (
              <StyledEditContainer>
                <StyledEditButton onClick={() => navigate(`/talk/edit/${id}`)}>
                  수정
                </StyledEditButton>
...
TalkDescription.displayName = 'TalkDescription';
